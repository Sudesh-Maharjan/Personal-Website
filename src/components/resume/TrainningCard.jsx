...
const TrainningCard = ({ title, subTitle, location,des }) => {
  return (
    <div className="flex w-full h-1/3 group">
      ...
      <div className=" hover:cursor-pointer flex flex-col justify-center h-[150px] w-full gap-6 p-4 duration-300 rounded-lg bg-neutral-600 bg-opacity-80 hover:bg-opacity-100 lgl:px-10 lgl:gap-10 ">
