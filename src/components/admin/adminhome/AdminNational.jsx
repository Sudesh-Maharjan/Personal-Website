...
const AdminNational = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editItem) {
        await axios.put(`${API_URL}/national/${editItem.id}`, formData);
        Swal.fire('Success!', 'National data updated successfully!', 'success');
        setEditItem(null);
      } else {
        await axios.post(`${API_URL}/national`, formData);
        Swal.fire('Success!', 'National data added successfully!', 'success');
      }
  ...
  const handleDelete = async (itemId) => {
    ...
    if (isConfirmed.isConfirmed) {
      try {
        await axios.delete(`${API_URL}/national/${itemId}`);
        Swal.fire('Deleted!', 'National data deleted successfully!', 'success');
        fetchData();
      } catch (error) {
  ...
  return (
    <div className="container mx-auto mt-8 p-4">
      <h1 className="text-2xl font-bold mb-4">Admin National</h1>
