...
const AdminBusiness = () => {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            ...
            formDataObject.append('_id', editFormData._id);

            await axios.put(`${API_URL}/business/${editFormData._id}`, formDataObject, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
        ...
        <div className="container mx-auto mt-8 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                {businesses.map((business) => (
                    <div key={business._id} className="bg-white p-4 rounded-lg shadow-md">
